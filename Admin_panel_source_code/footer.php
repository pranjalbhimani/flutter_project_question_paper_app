    ...
    <!--Footer Start Here -->
    <footer class="footer-container" style="position: fixed;left: 0;
   bottom: 0;
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="footer-left">
                        <span>© 2021 <a href="#">Gls University</a></span>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="footer-right">
                        <span class="footer-meta">Crafted with&nbsp;<i class="fa fa-heart"></i>&nbsp;by&nbsp;<a href="#">Pranjal Bhimani</a></span>
                    </div>
                </div>
            </div>
        </div>
...
<script src="admin_asset/js/lib/jquery.ui.js"></script>
<script src="admin_asset/js/lib/jRespond.js"></script>
<script src="admin_asset/js/lib/nav.accordion.js"></script>
<script src="admin_asset/js/lib/hover.intent.js"></script>
<script src="admin_asset/js/lib/hammerjs.js"></script>
<script src="admin_asset/js/lib/jquery.hammer.js"></script>
<script src="admin_asset/js/lib/jquery.fitvids.js"></script>
<script src="admin_asset/js/lib/scrollup.js"></script>
<script src="admin_asset/js/lib/smoothscroll.js"></script>
<script src="admin_asset/js/lib/jquery.slimscroll.js"></script>
<script src="admin_asset/js/lib/jquery.syntaxhighlighter.js"></script>
<script src="admin_asset/js/lib/velocity.js"></script>
<script src="admin_asset/js/lib/smart-resize.js"></script>
<!--Forms-->
<script src="admin_asset/js/lib/jquery.maskedinput.js"></script>
<script src="admin_asset/js/lib/jquery.validate.js"></script>
<script src="admin_asset/js/lib/jquery.form.js"></script>
<script src="admin_asset/js/lib/additional-methods.js"></script>
<script src="admin_asset/js/lib/j-forms.js"></script>
<!--[if lt IE 10]>
<script src="js/lib/jquery.placeholder.min.js"></script>
<![endif]-->
<!--Select2-->
<script src="admin_asset/js/lib/select2.full.js"></script>
<script src="admin_asset/js/lib/jquery.loadmask.js"></script>
<script src="admin_asset/js/apps.js"></script>
</body>

<!-- Mirrored from www.lab.westilian.com/westilo-admin/full-width-fluid-layout/form-all-elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Nov 2019 05:21:18 GMT -->
</html>